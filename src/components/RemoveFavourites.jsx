const RemoveFavourites = () => {
    return (
        <>
        <span classNmae="mr-2">Remove from favourites</span>
        <svg 
     ...
     />
        <path
         ...
         8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.
         293 8 4.646 5.354a.5.5 0 0 1 0-.708z"
     />
  </svg>
</>
);
